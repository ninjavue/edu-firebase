...
const user = {
    ...
    actions: {
        ...
        getByIdUser: async (context, payload) => {
            try {
                const res = await context.dispatch('getDataById', {
                    url: 'users',
                    id: payload
                })
        ...
        postUser: async (context, payload) => {
            try {
                const res = await context.dispatch('postData', {
                    url: 'users',
                    data: payload
                });
                context.commit('addUser', res);
                return res.id;
            } catch (error) {
                alert(error.message);
                throw error;
